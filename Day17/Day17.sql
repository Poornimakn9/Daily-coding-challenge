...
select c.customer_name, o.order_id, o.amount from customers c 
...
select c.customer_name, o.order_id, p.payment_status from orders o
...
select c.customer_name, SUM(o.amount) AS total_spent from customers c
...
select c.customer_name, MAX(o.amount) as highest_order from customers c
INNER JOIN orders o on c.customer_id = o.customer_id group by c.customer_name;
select c.customer_name, SUM(o.amount) AS total_spent from customers c
INNER JOIN orders o on c.customer_id = o.customer_id  group by c.customer_name
